...
class InsertNewScannedProductUseCaseTest {

    private val repository = mockk<ScannedProductsRepository>()
    ...
    fun `overwrites addedAt with now and calls repository`() = runTest {
        ...
        coVerify(exactly = 1) { repository.saveScannedProductToDatabase(any()) }
