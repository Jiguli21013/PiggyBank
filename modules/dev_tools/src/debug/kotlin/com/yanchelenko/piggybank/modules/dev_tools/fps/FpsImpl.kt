...
import com.yanchelenko.piggybank.modules.core.core_api.debugTools.Fps
...
class FpsImpl : Fps, Choreographer.FrameCallback {
    ...
    override fun start() {
        ...
        mainScope.launch { choreographer.postFrameCallback(this@FpsImpl) }
    }
    ...
    override fun stop() {
        ...
        mainScope.launch { choreographer.removeFrameCallback(this@FpsImpl) }
        mainScope.cancel()
    }
